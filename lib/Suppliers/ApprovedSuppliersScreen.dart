          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 1.h),
                approvedsuppliersmodal?.suppliers?.length == 0 || approvedsuppliersmodal?.suppliers?.length == null
                    ? Container(
                  height: 80.h,
                  alignment: Alignment.center,
                  child: Text(
                ...
                Container(
                  ...
                  child:ListView.builder(
                    padding: EdgeInsets.zero,
                    itemCount: more
                        ? (approvedsuppliersmodal?.suppliers?.length ?? 0) <= 4
                            ...
                            Row(
                              children: [
                                Container(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: CachedNetworkImage(
                                      fit: BoxFit.cover,
                                      imageUrl:
                                      approvedsuppliersmodal?.suppliers?[index].profile ?? "",
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      approvedsuppliersmodal?.suppliers?[index].name ?? "",
                                      style: TextStyle(
                                          fontSize: 16.sp,
                                          fontWeight: FontWeight.bold,
                                          letterSpacing: 1,
                                    ...
                                    SizedBox(
                                      width: 55.w,
                                      child: Text(
                                        approvedsuppliersmodal?.suppliers?[index].description ?? "" ,
                                        maxLines: 2,
                                        style: TextStyle(
                                          height: 1.3,
                                          fontSize: 14.sp,
                                      ...
                                      child: InkWell(
                                        onTap: () {
                                          Get.to(SupplierfourScreen(
                                            catid: approvedsuppliersmodal?.suppliers?[index].categoryId ?? "",
                                            suppid: approvedsuppliersmodal?.suppliers?[index].id ?? "",
                                            service:  approvedsuppliersmodal?.suppliers?[index].categoryName ?? "",
                                          ));
                                        },
                                        child: Container(
                                          alignment: Alignment.center,
