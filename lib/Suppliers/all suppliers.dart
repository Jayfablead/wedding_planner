                      ...
                      return Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              (categorywisesuppliersmodal?.suppliers?[index].name)==""||(categorywisesuppliersmodal?.suppliers?[index].name)==null?"N/A":(categorywisesuppliersmodal?.suppliers?[index].name).toString(),
                            ...
                            Text(
                              (categorywisesuppliersmodal?.suppliers?[index].description)==""||(categorywisesuppliersmodal?.suppliers?[index].description)==null?"N/A":(categorywisesuppliersmodal?.suppliers?[index].description).toString(),
