                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Container(
                                                            width: 65.w,
                                                            child: Text(
                                                              (checklistmodal?.all?[index].taskTitle) ==
                                                                          "" ||
                                                                      (checklistmodal
                                                                              ?.all?[
                                                                                  index]
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: [
                                                              ...
                                                              Container(
                                                                width: 65.w,
                                                                child: Text(
                                                                  (checklistmodal?.todayAlerts?[index].taskTitle) ==
                                                                              "" ||
                                                                          (checklistmodal?.todayAlerts?[index].taskTitle) ==
                                                                              null
                                                                      ? "N/A"
                                                                      : (checklistmodal
                                                                          ...
                                                                          .toString(),
                                                                  style: TextStyle(
                                                                      color: (checklistmodal?.todayAlerts?[index].isCompleted ==
                                                                              "1"
                                                                          ? Colors
                                                                              .blue
                                                                          : Colors
                                                                              .black87),
                                                                      decoration: (checklistmodal?.todayAlerts?[index].isCompleted ==
                                                                              "1"
                                                                          ? TextDecoration
                                                                              .lineThrough
                                                                          : TextDecoration
                                                                ...
                                                                children: [
                                                                  InkWell(
                                                                      onTap:
                                                                        ...
                                                                        setState(
                                                                            () {
                                                                          val = checklistmodal?.completed?[index].isCompleted == "1"
                                                                              ? 0
                                                                              : 1;
                                                                        });
                                                                      },
                                                                  ...
                                                                  Container(
                                                                    width: 78.w,
                                                                    child: Text(
                                                                      (checklistmodal?.completed?[index].taskTitle) == "" ||
                                                                              (checklistmodal?.completed?[index].taskTitle) ==
                                                                                  null
                                                                          ? "N/A"
                                                                          : (checklistmodal?.completed?[index].taskTitle)
                                                              ...
                                                              child: Row(
                                                                ...
                                                                children: [
                                                                  InkWell(
                                                                    ...
                                                                    child: checklistmodal?.pending?[index].isCompleted ==
                                                                            "1"
                                                                        ? Icon(
                                                                            Icons.check_box_rounded,
                                                                            color:
                                                                  ...
                                                                  Container(
                                                                    width: 65.w,
                                                                    child: Text(
                                                                      (checklistmodal?.pending?[index].taskTitle) == "" ||
                                                                              (checklistmodal?.pending?[index].taskTitle) ==
                                                                                  null
                                                                          ? "N/A"
                                                                          : (checklistmodal?.pending?[index].taskTitle)
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  sel1 == 0
                                      ? (checklistmodal?.all?[var1!].taskTitle)
                                          .toString()
                                      : sel1 == 1
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  sel1 == 0
                                      ? (checklistmodal?.all?[var1!].startTime)
                                          .toString()
                                      : sel1 == 1
                                          ? (checklistmodal?.todayAlerts?[var1!]
                                                  .startTime)
