                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        userprofile?.userDetails?.bookingReq==""||userprofile?.userDetails?.bookingReq==null?"N/A":(userprofile?.userDetails?.bookingReq).toString(),
                                        style: appname,
                                      ),
                                    ],
                                  ),
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        userprofile?.userDetails?.bookingReq==""||userprofile?.userDetails?.bookingReq==null?"N/A":(userprofile?.userDetails?.quotationReq).toString(),
                                        style: appname,
                                      ),
                                    ],
                                  ),
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 1.h),
                                  Text(
                                    userprofile?.userDetails?.phone==""||userprofile?.userDetails?.phone==null?"N/A":(userprofile?.userDetails?.phone).toString(),
                                    style: appname,
                                  ),
                                ],
                              ),
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: ReadMoreText(
                                        ...
                                        lessStyle: TextStyle(
                                            ...
                                            color: Colors.blue,
                                            fontWeight: FontWeight.bold),
                                        userprofile?.userDetails?.address==""||userprofile?.userDetails?.address==null?"N/A":(userprofile?.userDetails?.address).toString(),
                                        style: TextStyle(
                                            color: Colors.black,
                                            fontSize: 13.sp,
                                            fontFamily: 'sofi',
