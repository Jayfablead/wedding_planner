                ...
                child: Center(
                  child: CustomScrollView(
                    slivers: [
                      ...
                      SliverToBoxAdapter(
                          child: SizedBox(
                        height: floordetalismodal?.data?.length == 0 ||
                                floordetalismodal?.data?.length == null
                            ? 30.h
                            : 45.h,
                        child: floordetalismodal?.data?.length == 0 ||
                                floordetalismodal?.data?.length == null
                            ? Center(
                                child: Text(
                                    ...
                                    child: GestureDetector(
                                      onTap: () {
                                        Get.to(FloorDetalisScreen(
                                          id: floordetalismodal?.data?[index].id
                                              .toString(),
                                        ));
                                      },
                                      child: Column(
