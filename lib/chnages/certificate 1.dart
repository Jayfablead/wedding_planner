...
class Certificate1 extends StatefulWidget {
  const Certificate1({super.key});

  @override
  State<Certificate1> createState() => _Certificate1State();
}
...
class _Certificate1State extends State<Certificate1> {
  @override
