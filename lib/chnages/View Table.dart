                              ...
                              Padding(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text(
                                      "Available Seats " +
                                          ( int.parse((guestseatingmodal?.suppliersDetails?[index].table?.capacity).toString())-int.parse((guestseatingmodal?.suppliersDetails?[index].guestList?.length).toString())
                                          ).toString() +
                                          " out of " +
                                          (guestseatingmodal
                                              ?.suppliersDetails?[
